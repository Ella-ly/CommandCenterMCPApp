 ...
 * Output goes to ../assets/<widget-name>.html, which the MCP server reads and serves
 * as an MCP resource (mimetype text/html+mcpwidget).
 */
...
const widgets = [{ name: "dashboard", entry: "src/dashboard/index.html" }];
